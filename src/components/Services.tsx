  ...
  return <section id="services" className="py-20 bg-professional-gray/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => <Card key={index} className="relative bg-gradient-card shadow-card hover:shadow-lg transition-all duration-300 border-0 group">
              ...
              {expandedService === index && <CardContent className="space-y-6 animate-fade-in">
                  {/* Features List */}
