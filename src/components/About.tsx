...
const About = () => {
  ...
  const differentials = [
    ...
    "Peças originais e equipamentos de qualidade",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              A MORE SISTEMS nasceu da paixão por proporcionar conforto térmico com qualidade e confiança. 
              Com mais de 5 anos de experiência, nossa equipe especializada atende residências e empresas 
              com soluções personalizadas em climatização.
            </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <Card key={index} className="bg-gradient-card shadow-card border-0 text-center p-6 hover:shadow-lg transition-all duration-300">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <Card key={index} className="bg-gradient-card shadow-card border-0 text-center hover:shadow-lg transition-all duration-300 group">
